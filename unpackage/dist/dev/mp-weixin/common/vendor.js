...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "顺手办校园驿站",
      enablePullDownRefresh: true
    }
  },
  {
    path: "pages/switchPhone/switchPhone",
    style: {
      navigationBarTitleText: "寄件"
    }
  },
  {
    path: "pages/expressdetail/expressdetail",
    style: {
      navigationBarTitleText: "快递详情"
    }
  },
  {
    path: "pages/shippingdetail/shippingdetail",
    style: {
      navigationBarTitleText: "寄件详情"
    }
  },
  {
    path: "pages/introdetail/introdetail",
    style: {
      navigationBarTitleText: "推文"
    }
  },
  {
    path: "pages/addressproduce/addressproduce",
    style: {
      navigationBarTitleText: "生成地址"
    }
  },
  {
  ...
  {
    path: "pages/searchexpressdata/searchexpressdata",
    style: {
      navigationBarTitleText: ""
    }
  }
...
const globalStyle = {
  ...
  navigationBarTitleText: "顺手办校园服务中心",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "169.254.6.173",\n        "169.254.253.41",\n        "192.168.192.174",\n        "172.24.192.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"alipay","spaceName":"post-station","spaceId":"env-00jxgt5r6k5b","spaceAppId":"2021004146671496","accessKey":"4unim4RwxHlYysaV","secretKey":"1SrtVNXhKKgihvfR"}]') || [];
let O = "";
try {
  O = "__UNI__48925EC";
} catch (e2) {
